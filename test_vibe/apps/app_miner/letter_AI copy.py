...
class ExcelKnowledgeArchitect:
    ...
    def create_draft_processes_from_blueprint(self, project):
        ...
        from apps.app_knowledge.models import KnowledgeDraft
        from .models import DataEntry, DataField

        sheets = DataEntry.objects.filter(project=project)
        created_count = 0
    ...
    def call_ai_with_dynamic_task(self, draft_obj, template_name="USER_GUIDE", is_bulk=False):
        ...
        from apps.app_knowledge.models import AIPromptTemplate, KnowledgeDraft, BusinessLogicRule
    ...
    def _save_extracted_knowledge(self, draft_obj, data):
        ...
        from apps.app_knowledge.models import KnowledgeDraft, BusinessLogicRule
