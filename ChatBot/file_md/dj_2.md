# HƯỚNG DẪN ĐỔI TÊN APP TRONG DJANGO (DỰ ÁN KPHT)
Mẹo :
...
---
**Ghi chú cho Team KPHT:** Sau khi đổi tên xong, hãy chạy lệnh `python manage.py runserver` để kiểm tra xem hệ thống có báo lỗi `ModuleNotFoundError` ở đâu không.