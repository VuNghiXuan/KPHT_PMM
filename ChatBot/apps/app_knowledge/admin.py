...
class KnowledgeDraftAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        from django.apps import apps
        try:
            ExcelProject = apps.get_model('app_miner', 'ExcelProject')
            project = ExcelProject.objects.first() 
...
class LearningLogResource(resources.ModelResource):
    project = fields.Field(column_name='project', attribute='project', widget=ForeignKeyWidget('app_miner.ExcelProject', 'name'))
    class Meta:
        model = LearningLog
