...
#     # 🔄 Quản lý vòng đời tri thức (knowledge_lifecycle_views.py)
#     path('<int:group_id>/knowledge/', knowledge_management, name='knowledge_management'),
#     path('<int:group_id>/knowledge/<int:knowledge_id>/<str:action>/', knowledge_action_view, name='knowledge_action'),
#     path('groups/<int:group_id>/knowledge/<int:pk>/rollback/', rollback_knowledge, name='knowledge_rollback'),
...
#     path(
#         'groups/<int:group_id>/knowledge/chapters/', 
#         knowledge_chapter_list_view, 
#         name='knowledge_chapter_list'
#     ),
#     path(
#         'groups/<int:group_id>/knowledge/chapters/<int:chapter_id>/action/', 
#         approve_reject_chapter_view, 
#         name='approve_reject_chapter'
#     ),
#     path('groups/<int:group_id>/knowledge/', knowledge_dashboard_view, name='knowledge_dashboard'),
